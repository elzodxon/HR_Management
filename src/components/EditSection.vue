<template>
  <Main>
    <div class="container p-5">
      <form class="needs-validation" @submit.prevent="updateButton">
        <div class="form-row">
        ...
        <div class="form-row">
          <div class="col-md-6 mb-6">
            ...
            <select class="custom-select" id="validationCustom04" v-model="form['selected']"
          ...
          <fieldset class="form-group">
            <div class="row">
              <label class="col-form-label col-md-6  pt-2 font-weight-bold">Gender</label>
       ...
       <div class="form-row">
        ...
        <input class="btn btn-primary mt-2" type="submit" value="Update and save">
      </form>
